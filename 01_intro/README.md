...
Эти два момента: полнота окружения программы и изоляция её от других программ, - легли в основу контейнеризации.
...
- **виртуализация** - технология, позволяющая запускать экземпляр операционной системы в рамках другой операционной системы.
- **контейнеризация** - метод виртуализации, в котором используются ресурсы ядра операционной системы.
- **изоляция процессов** - возможность запускать несколько процессов в рамках одной операционной системы, но с изолированными друг от друга ресурсами.
- **chroot** - системный вызов Unix, изменяющий местоположение корневой папки процесса и его дочерних элементов.
- **гипервизор** - программа виртуализации, реализующая эмуляцию аппаратных средств.
- **виртуальная машина** - экземпляр операционной системы, запущенный в рамках другой операционной системы.
- **контейнер** - изолированный экземпляр приложения, запущенный в рамках операционной системы.
