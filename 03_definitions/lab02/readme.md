...
- `1 балла` - использование параграфов `markdown`
- `1 балла` - использование заголовков `markdown`
- `1 балла` - использование списков `markdown`
- `1 балла` - использование изображений `markdown`
- `1 балл` - публикация кода на GitHub в ветку `lab02`
