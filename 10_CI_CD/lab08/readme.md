...
- `1 балл` - создана директория `./site` с Web приложением;
- `1 балл` - создана директория `./sql` с файлом `schema.sql`;
- `1 балл` - создана директория `./tests` с файлами `testframework.php` и `tests.php`;
- `1 балл` - создан файл `Dockerfile`;
- `1 балл` - создан файл `.github/workflows/main.yml`;
- `0.5 балл` - наличие цели работы в файле `README.md`
- `0.5 балл` - наличие задания в файле `README.md`
